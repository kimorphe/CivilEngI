...
For vectors in three dimensional space, yet another vector multiplication called 
exterior or cross product may be defined. 
For given pair of vectors $\fat{a}$ and $\fat{b}$, the cross product denoted by
 $\times$ produces a third vector. The defining propertis of the cross product 
are as follows. 
\begin{equation}
...
required for the cross product that the tuple:
\begin{equation}
